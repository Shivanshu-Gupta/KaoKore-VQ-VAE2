...
\begin{abstract}
    ...
    We will explore using Vector Quantized Variational Autoencoder (VQ-VAE) to generate discrete representations for faces in traditional japanese paintings.
    While Autoencoders typically learn continuous latent representations for data, the recent success of VQ-VAE demonstrates the advantages of discrete latent variables.
    While continuous representations are flexible, many real world attributes are better defined discretely, and some current state of the art network architectures, like transformers, only work on discrete data.
    In this project, we will experiment with VQ-VAEs on a novel dataset and design experiments to test the advantages and disadvantages of this approach.
