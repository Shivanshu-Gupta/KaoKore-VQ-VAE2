...
if __name__ == '__main__':
    ...
    parser.add_argument('--vq_vae2', type=str)
    ...
    model_vqvae2 = load_model('vq_vae2', args.vq_vae2, device)
    ...
    decoded_sample = model_vqvae2.decode_code(top_sample, bottom_sample)
